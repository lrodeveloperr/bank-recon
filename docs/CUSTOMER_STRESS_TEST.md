...
Archive backup/restore, StoreKit refresh, evidence rendering, remaining input adapters and hardware performance remain release blockers. Those gaps prevent an engine-lock claim.
