...
def main() -> None:
    ...
    checks = {
        ...
        "explicit_unsupported_adapter_gate": "case .xlsx, .ofx, .qfx, .qbo, .qif, .qmtf, .camt053, .camt054, .mt940, .bai2" not in swift and "throw EngineError.unsupportedFormat" in swift,
